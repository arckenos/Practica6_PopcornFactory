...
class catalogo : AppCompatActivity() {
    ...
    fun cargarPeliculas(){
        peliculas.clear()
        peliculas.add(
            Pelicula("Big hero",R.drawable.bighero6,R.drawable.headerbighero6,
        ...
        peliculas.add(
            Pelicula("1917", R.drawable.mil, R.drawable.milheader,
        ...
        peliculas.add(
            Pelicula("Leap year", R.drawable.leapyear, R.drawable.leapyearheader,
        ...
        peliculas.add(
            Pelicula("Toy Story", R.drawable.toystory, R.drawable.toystoryheader,
        ...
        peliculas.add(
            Pelicula("Inception", R.drawable.inception, R.drawable.inceptionheader,
        ...
        //Series
        peliculas.add(
            Pelicula("Dr.House", R.drawable.drhouse, R.drawable.househeader,
        ...
        peliculas.add(
            Pelicula("Smallville", R.drawable.smallville, R.drawable.smallvilleheader,
        ...
        peliculas.add(
            Pelicula("Dr.Who", R.drawable.drwho, R.drawable.drwhoheader,
        ...
        peliculas.add(
            Pelicula("Bones", R.drawable.bones, R.drawable.bonesheader,
        ...
        peliculas.add(
            Pelicula("Friends", R.drawable.friends, R.drawable.friendsheader,
    ...
    class PeliculaAdapter : BaseAdapter {
        ...
        override fun getView(p0: Int, p1: View?, p2: ViewGroup?): View {
            ...
            //var nombre = vista.tv_titulo.setText(pelicula.titulo) as TextView
